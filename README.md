...
- Se puede analizar de la señal original lo siguiente:se observa una señal con bastante variabilidad lo cual es normal porque las señales electromiográficas son y cambizntes durante la contracción y relajación del músculo; también en la señal parece haber interferencias de alta frecuencia (picos muy rápidos),esta característica se da por las contracciones repetitivas que se realizaron sin descanso del músculo; y por último que la amplitud disminuye con el tiempo, lo cual podría indicar fatiga muscular.

- El filtrado de las señales es de suma importancia ya que la EMG puede estar contaminado con movimientos involuntarios del sujeto, que generan frecuencias bajas (< 20 Hz) y eliminarlas ayuda a aislar la actividad muscular real, además de que estudios en EMG indican que las señales musculares útiles están por encima de 20 Hz y gracias a este filtro pasa bajas se eliminan fluctuaciones lentas que no corresponden a la contracción muscular ytambién se mantiene la información relevante de los potenciales de acción de la unidad motora.En cuanto al filtro pasa altas, la señal EMG puede estar contaminada con la interferencia eléctrica de 60 Hz y este filtro de igualmanera elimina ruidos electrónicos generados por el amplificador y otros equipos; este filtro ayuda a  conservar la parte principal de la señal EMG, ya que la mayoría de la actividad muscular está entre 20 y 450 Hz, pero en estudios de fatiga, se priorizan frecuencias menores a 60 Hz.

- También se pueden observar los beneficios de usar aventamiento en este caso y por esto se obtiene un mejor análisis en el dominio de la frecuencia (reduce el ruido espectral y evita bordes bruscos que podrían introducir artefactos en la señal.Al dividir la señal en ventanas temporales y analizar su contenido espectral, se observó que la energía se redistribuye en diferentes frecuencias a medida que avanza el tiempo. Esto es un comportamiento esperable, ya que la activación muscular no es estática y puede verse influenciada por variaciones en la fuerza aplicada, el reclutamiento de unidades motoras y la adaptación neuromuscular. Sin embargo, los cambios no siguen un patrón claro de desplazamiento hacia frecuencias más bajas, lo cual suele ser característico de la fatiga muscular.
  
- El análisis espectral de una señal electromiográfica (EMG) es una herramienta clave en la evaluación de la fatiga muscular.La Transformada rápida de Fourier,es la herramienta utilizada en el análisis espectral y esta  permite analizar la distribución de energía en diferentes frecuencias,ayuda a identificar ruidos no deseados (como interferencia eléctrica en 50-60 Hz),y es útil para extraer características de la señal, como la frecuencia media o la frecuencia mediana en estudios de fatiga muscular. Se sabe que a medida que un músculo se fatiga, la distribución de energía en su espectro de frecuencia cambia debido a la disminución de la conducción de la fibra muscular y la acumulación de metabolitos que afectan la excitabilidad de la membrana. Un indicador comúnmente utilizado para evaluar este proceso es la frecuencia mediana del espectro de potencia, también se evaluó la frecuencia media en tres ventanas temporales de la señal EMG (inicio, mitad y final de la contracción).
y se puede analizar que no se evidenció una disminución clara de la frecuencia media a lo largo del experimento;aunque la magnitud total de la señal sí mostró una reducción, la frecuencia se mantuvo relativamente estable y esto sugiere que el músculo no alcanzó un estado de fatiga total durante el período de registro.En un músculo fatigado, la disminución de la velocidad de conducción de las fibras musculares provoca que las señales EMG se desplacen hacia el rango de frecuencias más bajas. En este análisis, sin embargo, la evolución de la frecuencia mediana no mostró una disminución progresiva. Por el contrario, hacia el final del registro se observó un incremento en la frecuencia mediana.

- Para determinar si la reducción en la frecuencia mediana es estadísticamente significativa, se aplicó una prueba de Wilcoxon comparando las primeras cinco ventanas con las últimas cinco. El resultado obtenido indica que no existe evidencia suficiente para afirmar que la frecuencia mediana haya disminuido de manera significativa. Este resultado implica que no se puede concluir que haya una tendencia clara de fatiga en la señal analizada. No obstante, esto no significa necesariamente que el músculo no esté fatigado, sino que los cambios en la señal EMG podrían no haber sido lo suficientemente pronunciados o podrían estar enmascarados por otros factores.

# Conclusión

En este experimento, se analizó la señal EMG para evaluar la presencia de fatiga muscular mediante el procesamiento en el dominio del tiempo y la frecuencia. Si bien se esperaba una disminución progresiva de la frecuencia media como indicador de fatiga, los resultados mostraron que esta se mantuvo relativamente estable a lo largo de la prueba. Esto sugiere que el músculo no alcanzó un estado de fatiga total, posiblemente debido a que la duración de la contracción o la intensidad del esfuerzo no fueron lo suficientemente altas para generar una disminución notable en la conducción nerviosa y la activación de unidades motoras. Sin embargo, se observó una reducción en la magnitud total de la señal EMG, lo que podría indicar una ligera disminución en la activación muscular con el tiempo. Estos hallazgos resaltan la importancia de ajustar las condiciones experimentales para inducir una fatiga más evidente, como aumentar la carga muscular o extender la duración de la contracción. En futuras pruebas, estos ajustes permitirían una mejor caracterización de los efectos de la fatiga muscular y su impacto en la señal EMG, lo cual es fundamental para aplicaciones en rehabilitación, entrenamiento deportivo y diagnóstico neuromuscular.
